...
const getBet = (balance,lines)=>{
    while (true){
        ...
        --NOTE:
         if the *totalbalance* amount is 50 and
         you want to bet  *numberOfLines* for 3 lines which means
         you can *numberOfBetperline* max of 16 per line i.e 16+16+16 = 48
...
/*
 --> Transpossing the metrix from column to row
 [
      [ 'D', 'D', 'B' ],
      [ 'B', 'D', 'C' ],
      [ 'A', 'C', 'B' ]
